...
Инструмент: debug-метод компонента `send_probe(cmd, r0, r1_extra, r3_extra)`
+ кнопки/number в YAML для проб, ИЛИ одноразовый lambda-скрипт.
Реакцию пишет пользователь; результаты — в эту таблицу.
